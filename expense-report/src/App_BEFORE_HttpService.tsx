...
//we can create a api-client module and set config params in it
//export that module and use it here
//in src create new folder services and in services create new file
//services are not about GUI but about functionality
//api-client can be used for Canceled Error object from axios as well
//so you can remove axios import from this App.tsx itself

//App.tsx as component should be like chef, only cooking; not shop ingredients
//App.tsx hould only return mark-up and handle user interaction at high level
//nothing else
